...
class Node(ClientNode):
    ...
    def step(self, current_time, time_step):
        ...
        print("Tsupply", self.input_values.items())
        ...
        logging.debug(self.name, "outputs", {key: self.fmu.getRealValue(key) for key in self.output_attributes})
        print("Tsupply_endPipe", self.output_attributes)
