...
model Carnot_TCon
 ...
 package Medium2 = IBPSA.Media.Water "Medium model";
  ...
  Modelica.Blocks.Interfaces.RealInput SetT(unit="K") ;
  ...
  IBPSA.Fluid.Sources.MassFlowSource_T sou1(nPorts=1,
...
equation
  ...
  connect(SetT, heaPum.TSet) annotation (Line(points={{-59,50},{-20,50},{
          -20,9},{-12,9}},
                     color={0,0,127}));
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/HeatPumps/Examples/Carnot_TCon.mos"
        "Simulate and plot"),
    Documentation(
info="<html>
<p>
